...
export const generateComplementaryTheme = (color = null) => {
  ...
  const darkColor = seed.darken(15).toRgb();
  ...
  newTheme.colors.toolbar_top_separator = darkColor;
  newTheme.colors.toolbar_vertical_separator = darkColor;
  newTheme.colors.toolbar_bottom_separator = darkColor;
  newTheme.colors.toolbar_field_border = darkColor;
  newTheme.colors.popup_border = darkColor;
